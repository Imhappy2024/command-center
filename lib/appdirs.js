...
/* state holds small registers this app keeps for itself -- which CLI sessions
   were an analyst pulling metrics rather than somebody's chat, and the like.
   Not user files, and nothing in here is served. */
export const KINDS = ['attachments', 'uploads', 'clips', 'state'];
