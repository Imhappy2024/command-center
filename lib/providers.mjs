...
/* gmail.modify covers reading, labels, archive and trash; gmail.compose covers
   drafts and sending. Neither implies the other, and readonly is a subset of
   modify, so it is not listed separately. */
const GOOGLE_SCOPES = [
  'openid',
  'email',
  ...
  google: {
    ...
    authorizeUrl(env, { redirect, state }){
      return 'https://accounts.google.com/o/oauth2/v2/auth?' + new URLSearchParams({
        ...
        // same address, and the store overwrites the account you already had.
        // consent is still needed to guarantee a refresh_token on reconnects.
