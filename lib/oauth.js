...
/* Three scopes because they are three different things: the Data API knows the
   ...
   another tab mostly does not get applied. It is the narrow one: /auth/youtube
   manages the account's own videos and playlists. force-ssl would also carry
   comment moderation and captions, which nothing here touches.
   ...
   that failure is reported as "reconnect YouTube to grant editing" rather than
   as a bare 403. */
