...
/* drive.readonly is here so Hommie can turn "the day one video in Raw videos"
   into a real file. Read only: finding a file is the whole job, and the write
   scope would also let a misheard sentence move or delete one.
